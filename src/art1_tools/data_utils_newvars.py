...
from Graphcast_model import solar_radiation
import numpy as np
import pandas as pd
import xarray
...
def extract_inputs_targets_forcings(
  ...
  # [02-04-2023]: este condicional sirve para no seleccionar por nivel 
  #               dado que solo trabajamos con una variable sin dim de level
  #               se probo con level de tamano 1 pero mas adelante nos da 
  #               nan la perdida debido a que es ponderada por level.
